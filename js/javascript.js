...
function showMenu(){
	var menuList = ['ADIDAS','BALENCIAGA','GUCCI','NIKE'];
...
function createAdmin(){
	if(localStorage.getItem('user')===null){
		var userArray = [];
		var user = {username: 'admin', password: 'admin', fullname: 'Nguyễn Minh Đức', address: '273 An Dương Vương, P3, Quận 5, TPHCM', phone: '0123456789' , datesignup: '3-12-2021'};
		userArray.push(user);
